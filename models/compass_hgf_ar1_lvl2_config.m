function c = compass_hgf_ar1_lvl2_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
c.logitphimu = [NaN, tapas_logit(0.5,1), -Inf]; % modified instead of -Inf
...
c.prc_fun = @compass_hgf_ar1_lvl2;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @compass_hgf_ar1_lvl2_transp;
